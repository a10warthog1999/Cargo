...
<div class="topnav">
<?php
  echo '<a class="active" href ="add_form4.php">ADD NEW CAR</a>';
			...
			if(mysqli_num_rows($res)>0)
			{
				...
				<?php
					...
					<td style="text-align: center">
						<form action="del4.php" method="POST">
					...
					<td style="text-align:center">
						<form action="mod_e.php" method="POST">
							<input type="hidden" name="mid" value="<?php echo $row['CARID']; ?>">
							<input type="submit" align="center" style="height:50px;background-color:white; width:100px" value="UPDATE"/>
