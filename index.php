...
<div class="topnav">
<?php
  echo '<a class="active" href ="add_form.php">ADD NEW CAR</a>';
  echo '<a href ="index2.php">MERCEDES</a>';
  echo '<a href ="index3.php">JAGUAR</a>';
  ...
  padding: 16px 32px;
	...
	<body bgcolor="lightgrey">
		...
		<?php
			...
			{
				?>
				<table class="table" border="1" width="1300px" height="350px" align="center">
					<tr bgcolor="black">
				...
				<?php
					...
					<td  style="text-align: center">
						 <form method="POST" action="tes.php" enctype="multipart/form-data">
  							<input type="hidden" name="size" value="<?php echo $row['CARID']; ?>">
  							
  							<input type="submit" style="height:50px;background-color:white; width:100px" value="IMAGE"/>
  							</form>
					</td>
